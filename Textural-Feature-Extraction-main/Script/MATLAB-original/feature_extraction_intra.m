...
%% load data
cd('E:\GT\Research\CCF\ccf_feature_results_separate\Granuloma\intra_feature')
load gabor_intra
load haralick_intra
load law_intra
...
save('E:\GT\Research\CCF\ccf_feature_results_separate\Granuloma\intra_feature\intra','intra');
