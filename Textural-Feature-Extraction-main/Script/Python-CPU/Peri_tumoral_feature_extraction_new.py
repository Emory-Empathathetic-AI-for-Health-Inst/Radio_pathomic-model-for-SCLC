...
result_path = r'/users/PCON0521/achen653/6254/VA/benign_first_timepoint_200/benign_first_timepoint_200/Results/TEX/peri'

# Record the error
error_log = os.path.join(result_path, 'error_log_peri.txt')
...
def process_patient(patient_id):
    try:
        ...
        for mask_file in mask_files:
            ...
            results.append((peri, f"{patient_id}_{mask_file[:-7]}"))
...
if __name__ == '__main__':
    ...
    for patient_results in valid_results:
        for peri, name in patient_results:
            peri_features.append(peri)
    ...
    savemat(os.path.join(result_path, 'peri_nodule_list.mat'), {'peri_nodule_list': nodule_list})
